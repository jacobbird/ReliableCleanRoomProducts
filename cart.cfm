...
<script type="text/javascript">
		...
		var url="https://secure.reliablecleanroomproducts.com/ConfirmationPage.cfm?UI="+UniqueIdentifier;
		...
		window.close();
		window.open('https://secure.reliablecleanroomproducts.com/cart.cfm','_blank','resizeable=yes, scrollbars=yes, toolbar=no, menubar=no, width=932 ,height=300, top=150');
		}
...
<body onLoad="MM_preloadImages('images/cdwn.jpg','images/cover.jpg','images/ButtonBank/theRemoveButton_OVER.gif')" bgcolor="#666666">

<table width="518" background="images/Area Fill/CartPageBackGround.jpg" cellspacing="0" cellpadding="0" border=0>
	<tr>
		<td width="439" height="315">	
            ...
            range="0,300">
                      ...
                      <tr>
                        ...
                        <td>&nbsp;</td>
                        <td align="right"><cfinput name="MakePurchase" type="button" value="Make Purchase" onClick="window.open('https://secure.reliablecleanroomproducts.com/cart.cfm?action=checkout','_self','resizeable=yes, scrollbars=yes, toolbar=no, menubar=no, 		width=932 ,height=235, top=150');window.open('https://secure.reliablecleanroomproducts.com/EnterYourMailingAddress.cfm?action=init','window20','resizeable=yes,scrollbars=yes,toolbar=no, menubar=no,width=932,height=725,');"></td>
                        <td align="right">&nbsp;</td>
                      </tr>
                      <tr>
                        <td height="28">&nbsp; &nbsp;
                            <script type="text/javascript" src="https://sealserver.trustwave.com/seal.js?style=normal"></script></td>
