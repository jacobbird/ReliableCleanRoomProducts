...
<cfquery name="warehouse" datasource="warehouse">
Select UserID
from customersinfo
...
<cfquery name="update" datasource="warehouse">
Update customersinfo
Set Password='#Form.PasswordOne#'
Where UserID='#Form.UserID#'
</cfquery>
<cflocation url="https://secure.reliablescleanroomproducts.com/store.cfm">
<cffile action="delete" file="C:\websites\ReliableCleanRoomProducts\ChangePassPage#url.emailAddress#.cfm" >
...
<table width="364" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
  ...
  <tr>
    <td colspan="5" height="35" align="center" class="ArialStoreWhiteBold" background="images/Area Fill/Plain-Blue-Fill.jpg">Please Change Your Password</td>
  </tr>
  <tr>
    <td height="10"></td>
    <td colspan="3"></td>
